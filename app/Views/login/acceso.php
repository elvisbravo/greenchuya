...
<!-- Mirrored from shreyu.coderthemes.com/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Mar 2023 15:41:05 GMT -->
<head>
        <meta charset="utf-8" />
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="img/logos/grupoes.ico">
    ...
    <body class="authentication-bg">
                            ...
                            <div class="card-body p-0">
                                <div class="row g-0">
                                    <div class="col-lg-12 p-4">
                                        <div class="mx-auto">
                                            <a href="index.html">
                                                <img src="public/dashboard/img/logos/icon.png" alt="" height="30" />
                                                <span style="color: black; font-size: 22px; font-weight: bold; margin-left: 10px">GREEN CHUYA</span>
                                            </a>
                                        </div>
                                        ...
                                        <form action="#" class="authentication-form" id="authentication-form">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="hello@ejemplo.com" required="">
                                                </div>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Contraseña</label>
                                                <a href="pages-recoverpw.html" class="float-end text-muted text-unline-dashed ms-1">¿Olvidaste tu contraseña?</a>
                                                <div class="input-group">
                                                    <span class="input-group-text">
        ...
        <script src="public/dashboard/login.js"></script>
